...
const sections = [
  ...
  },
  {
    ...
    body: `We take reasonable administrative, technical, and physical measures to protect your personal information from unauthorized access, use, alteration, or disclosure. However, no method of transmission over the internet or electronic storage is 100% secure, and we cannot guarantee absolute security.\n\nIf you have reason to believe that your interaction with us is no longer secure, please contact us immediately at info@branhamgroup.com.`,
  },
  {
    title: '5. Third-Party Links',
    body: `Our website may contain links to third-party websites, including our social media profiles on LinkedIn, Facebook, and Instagram. We are not responsible for the privacy practices of those sites and encourage you to review their privacy policies independently. Our privacy policy applies only to information collected on branhamgroup.com.`,
  },
  {
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://www.branhamgroup.com/privacy" />
        <meta property="og:title" content="Privacy Policy | Branham Group, Inc." />
        <meta property="og:url" content="https://www.branhamgroup.com/privacy" />
